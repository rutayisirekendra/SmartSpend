...
```mermaid
flowchart TB
    User[Student User] --> UI[Flutter UI Layer]
    
    UI --> |watches| P[Provider State Layer]
    P --> |notifies| UI
    ...
    subgraph MLLayer [ML Kit Integration]
        direction TB
        CAM[Camera/Gallery]
    ...
    classDef userStyle fill:#1A535C,stroke:#4ECDC4,stroke-width:3px,color:#fff
    classDef uiStyle fill:#FF6B35,stroke:#FFA000,stroke-width:2px,color:#fff
    classDef stateStyle fill:#2196F3,stroke:#64B5F6,stroke-width:2px,color:#fff
    classDef serviceStyle fill:#4CAF50,stroke:#81C784,stroke-width:2px,color:#fff
    classDef storageStyle fill:#9C27B0,stroke:#BA68C8,stroke-width:2px,color:#fff
    classDef mlStyle fill:#FF6B35,stroke:#F57C00,stroke-width:2px,color:#fff
    classDef providerStyle fill:#1A535C,stroke:#4ECDC4,stroke-width:1px,color:#fff
    ...
    class MLLayer mlStyle
    class AS,ES,BS,GS,NS providerStyle
    class FA,FS,OCR,SS,DC providerStyle
    class HIVE,FIRE,CLOUD,FILES providerStyle
    class CAM,TXT providerStyle
```
...
<p>
  <img src="https://img.shields.io/badge/💰-Track%20Expenses-brightgreen?style=for-the-badge" alt="Track Expenses" />
  <img src="https://img.shields.io/badge/🎯-Reach%20Goals-blue?style=for-the-badge" alt="Reach Goals" />
  <img src="https://img.shields.io/badge/📊-Gain%20Insights-success?style=for-the-badge" alt="Gain Insights" />
</p>
